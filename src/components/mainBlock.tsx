...
const MainBlock = ({ setModalNeededBy, layout, setLayout, user }: ChildProps) => {
    ...
    return <div ref={containerRef} className="bg-mainComponentBg z-10 flex-1 pb-20 relative min-h-screen overflow-y-auto scrollbarMC">
        ...
        <div className=" mt-6  w-full flex justify-center ">
            ...
            <div className={` ${layout === "grid" ? " grid 2xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 xl:gap-6  lg:gap-4 gap-2 gap-y-6 " : " w-full "}  overflow-anchor-none`}>
