...
const MainBlock = ({setModalNeededBy, setPopUpLive } : ChildProps) => {
    ...
    useEffect(()=>{
        setCardList((prev) => [...prev, { title: "hv",layout,cardType: "twitter", createdAt: "ctcut", link: "iyfi" },{ title: "hv",layout,cardType: "reddit", createdAt: "ctcut", link: "iyfi" },{ title: "hv",layout,cardType: "instagram", createdAt: "ctcut", link: "iyfi" }]); 
    },[]);
    ...
    return<div className="bg-mainComponentBg z-10 flex-1 pb-20 relative h-full overflow-y-auto scrollbarMC">
        ...
        <div className=" mt-6  w-full flex justify-center ">
            <div className={` ${layout === "grid" ? " grid 2xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 xl:gap-6  lg:gap-4 gap-2 gap-y-6 " : " w-full " }`}> 
                ...
                <CardElement setPopUpLive={setPopUpLive} layout={layout} title=" wassup people this is crazy" note="you iaefi awoda awiwi jjjdddhhhf  djdh fhv thr etsr fgfu huu hioup pope and i" cardType="web" createdAt="11/12/2004" link="https://x.com/arunpudur/status/1919789338981712121" ></CardElement>
                ...
                <CardElement setPopUpLive={setPopUpLive} layout={layout} title=" wassup people this is crazy" note="you iaefi awoda awiwi jjjdddhhhf  djdh fhv thr etsr fgfu huu hioup pope and i" createdAt="11/12/2004" cardType="twitter" link="https://twitter.com/narendramodi/status/1919736905115054505"></CardElement>
                ...
                <CardElement setPopUpLive={setPopUpLive} layout={layout} title=" wassup people this is crazy " note="you iaefi awoda awiwi jjjdddhhhf  djdh fhv thr etsr fgfu huu hioup pope and i" createdAt="11/12/2004" cardType="instagram" link="https://www.instagram.com/p/DJVJJkktapz/?utm_source=ig_web_copy_link"></CardElement>
                
                <CardElement setPopUpLive={setPopUpLive} createdAt="11/12/2004" layout={layout} title="wassup people heheh this is crazy" note="you iaefi awoda awiwi jjjdddhhhf  djdh fhv thr etsr fgfu huu hioup pope and i" cardType="web" link="https://x.com/arunpudur/status/1919789338981712121" ></CardElement>
            </div> 
        </div>
    </div>
}  
