...
export const PopUp = ({ particularStyle, placeholder }: { particularStyle?: string, placeholder: string }) => {
    return <AnimatePresence><motion.div key="popup"
        ...
        transition={{ duration: 0.5, ease: "easeInOut" }}> <div className={` shadow-2xl z-100 w-92 h-9 text-xl flex justify-center items-center mx-auto  rounded-xl z-100 bg-white border-2 border-slate-600 text-black  ${particularStyle}`}>
