...
export const DeleteIcon =  React.memo(({ style, onClickHandler, layout }: genIconStyle) => {
...
export const ShareIcon =  React.memo(({ style, onClickHandler, layout }: genIconStyle) => {
...
export const PlusIcon =  React.memo(({ style, dim }: { style?: string, dim?: string }) => {
...
export const DropdownIcon =  React.memo(({ dim, style }: genIconStyle) => {
...
export const DropUpIcon =  React.memo(({ dim, style }: genIconStyle) => {
...
export const GridIcon =  React.memo(({ dim, style, onClickHandler }: genIconStyle) => {
...
export const ListIcon =  React.memo(({ dim, style, onClickHandler }: genIconStyle) => {
  return <div onClick={onClickHandler}><svg
    viewBox="0 0 24 24"
    fill="currentColor"
    height={dim}
...
export const RedirectIcon =  React.memo(({ dim, style, link, layout }: genIconStyle) => {
...
export const CrossIcon =  React.memo(({ dim, style }: genIconStyle) => {
...
export const CopyIcon =  React.memo(({ dim, style }: genIconStyle) => {
...
export const Dasboard =  React.memo(({ dim, style }: genIconStyle) => {
...
export const LeftIcon =  React.memo(({ dim, style }: genIconStyle) => {
...
export const Tick =  React.memo(({ dim, style }: genIconStyle) => {
...
export const Loader =  React.memo(({ dimh, dimw, style }: { dimh: string, dimw: string, style: string }) => {
...
export const UpArrow =  React.memo(({ dim, style }: genIconStyle) => {
...
export const DownArrow =  React.memo(({ dim, style }: genIconStyle) => {
  return <div><svg xmlns="http://www.w3.org/2000/svg" width={dim} height={dim} className={style} viewBox="0 0 24 24"
    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export const BlockIcon =  React.memo(({ style }: genIconStyle) => {
  return <svg fill="currentColor" className={style} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlSpace="Preserver" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M256,0C114.615,0,0,114.615,0,256s114.615,256,256,256s256-114.615,256-256S397.385,0,256,0z M336,320 c0,8.837-7.163,16-16,16H192c-8.837,0-16-7.163-16-16V192c0-8.837,7.163-16,16-16h128c8.837,0,16,7.163,16,16V320z"></path> </g></svg>
})

export const ChatLoader =  React.memo(({ dim, style }: genIconStyle) => {
  return <svg xmlns="http://www.w3.org/2000/svg" width={dim} height={dim} className={style} viewBox="0 0 200 200"><circle fill="#393365" stroke="#393365" strokeWidth="15" r="15" cx="40" cy="65"><animate attributeName="cy" calcMode="spline" dur="1.6" values="65;135;65;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="-.4"></animate></circle><circle fill="#393365" stroke="#393365" strokeWidth="15" r="15" cx="100" cy="65"><animate attributeName="cy" calcMode="spline" dur="1.6" values="65;135;65;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="-.2"></animate></circle><circle fill="#393365" stroke="#393365" strokeWidth="15" r="15" cx="160" cy="65"><animate attributeName="cy" calcMode="spline" dur="1.6" values="65;135;65;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="0"></animate></circle></svg>
})

export const BottomArrow =  React.memo(({ dim, style, onClickHandler }: genIconStyle) => {
  return <svg fill="#000000" height={dim} onClick={onClickHandler} width={dim} className={style} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 490 490" xmlSpace="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <polygon points="481.919,247.773 407.95,175.407 290.855,295.118 290.855,0 183.86,0 183.86,279.496 82.051,175.407 8.081,247.773 244.996,490 "></polygon> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> </g> </g></svg>
})

export const CopyText =  React.memo(({ dim, style, onClickHandler }: genIconStyle) => {
  return <svg height={dim} onClick={onClickHandler} width={dim} className={style} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M7.5 3H14.6C16.8402 3 17.9603 3 18.816 3.43597C19.5686 3.81947 20.1805 4.43139 20.564 5.18404C21 6.03969 21 7.15979 21 9.4V16.5M6.2 21H14.3C15.4201 21 15.9802 21 16.408 20.782C16.7843 20.5903 17.0903 20.2843 17.282 19.908C17.5 19.4802 17.5 18.9201 17.5 17.8V9.7C17.5 8.57989 17.5 8.01984 17.282 7.59202C17.0903 7.21569 16.7843 6.90973 16.408 6.71799C15.9802 6.5 15.4201 6.5 14.3 6.5H6.2C5.0799 6.5 4.51984 6.5 4.09202 6.71799C3.71569 6.90973 3.40973 7.21569 3.21799 7.59202C3 8.01984 3 8.57989 3 9.7V17.8C3 18.9201 3 19.4802 3.21799 19.908C3.40973 20.2843 3.71569 20.5903 4.09202 20.782C4.51984 21 5.0799 21 6.2 21Z" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>
})

export const CloseSideBar =  React.memo(({ dim, style, onClickHandler }: genIconStyle) => {
  return <svg height={dim} onClick={onClickHandler} width={dim} className={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export const OpenSideBar =  React.memo(({ dim, style, onClickHandler }: genIconStyle) => {
  return <svg height={dim} onClick={onClickHandler} width={dim} className={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <rect x="3" y="4" width="18" height="16" rx="2" ry="2" />
    <line x1="9" y1="4" x2="9" y2="20" />
